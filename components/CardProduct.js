...
export default function CardProduct({nama, harga, satuan, jumbeli}) {
    ...
    return(
        <div className="sm:w-[20%]  lg:w-[160px] min-h-[200px] bg-white/80 hover:bg-white hover:shadow-sm border border-transparent hover:border-primary rounded-[8px] relative grow lg:grow-0 p-2 duration-[150ms] ease-in">
